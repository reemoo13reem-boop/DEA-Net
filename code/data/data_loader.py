...
def create_train_val_split(hazy_path, clear_path, val_ratio=0.1):
    ...
    for key in train_keys:
        ...
        for hazy_name in scene_dict[key]:
            ...
            train_list.append(
                (
                    os.path.join(hazy_path, hazy_name),
                    os.path.join(clear_path, key)
                )
            )
...
class TrainDataset(data.Dataset):
    ...
    def __init__(self, hazy_path, clear_path):
        ...
        self.train_list, _ = create_train_val_split(
            hazy_path,
            clear_path,
            val_ratio=0.1
        )
    ...
    def __getitem__(self, index):
        ...
        crop_params = RandomCrop.get_params(
            hazy,
            output_size=(256, 256)
        )
...
class ValDataset(data.Dataset):
    ...
    def __init__(self, hazy_path, clear_path):
        ...
        _, self.val_list = create_train_val_split(
            hazy_path,
            clear_path,
            val_ratio=0.1
        )
